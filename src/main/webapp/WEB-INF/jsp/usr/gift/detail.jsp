...
<c:set var="pageTitle" value="선물 상세보기" />

<section class="container mx-auto p-6 bg-gray-50 rounded-lg shadow-lg">
    <h2 class="text-3xl font-bold text-pink-600 mb-8 text-center">선물 상세보기</h2>
        ...
        <table class="table-auto w-full border-collapse">
            <tbody>
                <tr class="border-b">
                    ...
                    <td class="px-4 py-2 text-gray-800">${present.senderName}</td>
                </tr>
                <tr class="border-b">
                    <th class="px-4 py-2 bg-pink-100 text-gray-700 text-left">받은 사람</th>
                    <td class="px-4 py-2 text-gray-800">${present.receiverName}</td>
                </tr>
                <tr class="border-b">
                    <th class="px-4 py-2 bg-pink-100 text-gray-700 text-left">선물</th>
                    <td><img src="/usr/pic/getImage?pic=${present.giftPic}"></td>
                </tr>
                <tr class="border-b">
                    <th class="px-4 py-2 bg-pink-100 text-gray-700 text-left">내용</th>
                    <td class="px-4 py-2 text-gray-800 whitespace-pre-line">${present.content}</td>
                </tr>
                <tr>
                    <th class="px-4 py-2 bg-pink-100 text-gray-700 text-left">보낸 날짜</th>
                    <td class="px-4 py-2 text-gray-800">${present.timestamp}</td>
                </tr>
            </tbody>
        </table>
    </div>
