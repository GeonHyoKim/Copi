        ...
        <div class="bg-white rounded-lg shadow-xl p-10 max-w-2xl mx-auto">
            ...
            <form action="doWrite" method="post" enctype="multipart/form-data" 
                ...
                <div class="space-y-6">
                    ...
                    <!-- 사진 업로드 -->
                    <div>
                        <label for="articlePics" class="block text-sm font-medium text-gray-700">사진</label>
                        <div class="relative group">
                            <input type="file" id="articlePics" name="articlePics" accept=".jpg,.jpeg,.png" multiple 
                                class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" onchange="previewImages(this)" />
                            <div class="flex items-center justify-center w-full h-12 bg-blue-500 text-white rounded-lg shadow-sm hover:bg-blue-600 transition duration-300 ease-in-out">
                                <img src="/upload/image.png" alt="사진 선택" class="h-8 w-8 mr-2" />
                                <span>사진 선택</span>
                            </div>
                        </div>
                        <p class="text-sm text-gray-500 mt-2">JPEG, PNG 형식의 사진을 최대 5장까지 업로드할 수 있습니다.</p>
                    </div>
