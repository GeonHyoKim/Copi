			...
			<form action="doJoin" method="post" enctype="multipart/form-data"
				...
				<div class="grid grid-cols-1 gap-6">
					...
					<div>
						<label class="block text-sm font-medium text-gray-700">비밀번호
							...
							placeholder="비밀번호를 다시 입력해주세요" class="input input-bordered w-full" />
					</div>
					<div>
				...
				<div class="mt-6 flex justify-between">
					<button type="button" onclick="history.back();"
						class="btn btn-outline btn-secondary">뒤로가기</button>
					<button type="submit"
						class="btn btn-primary bg-pink-500 hover:bg-pink-600 border-none">
						회원가입 하기</button>
				</div>
			</form>
		</div>
