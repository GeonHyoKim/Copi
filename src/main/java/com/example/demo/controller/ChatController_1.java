...
//	
//	public ChatController_1(ChatService chatService, HttpSession session, MemberService memberService) {
...
//    }
//	
//	@GetMapping("/usr/chat/test")
//	public String chatTest(Model model, @RequestParam int receiverId ) {
//		Member loginedMember = (Member) session.getAttribute("loginedMember");
